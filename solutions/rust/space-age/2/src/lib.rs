...
pub trait Planet {
    fn years_during(_d: &Duration) -> f64 {
        todo!("I need to be implemented, master")
    }
}
...
impl Planet for Mercury {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 0.2408467
    }
}
impl Planet for Venus {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 0.61519726
    }
}
...
impl Planet for Mars {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 1.8808158
    }
}
impl Planet for Jupiter {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 11.862615
    }
}
impl Planet for Saturn {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 29.447498
    }
}
impl Planet for Uranus {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 84.016846
    }
}
impl Planet for Neptune {
    fn years_during(d: &Duration) -> f64 {
        (d.seconds as f64 / EARTH_YEAR) / 164.79132
    }
}
