...
pub fn build_rec(
  ...
  case same_letter, is_odd_line {
    True, True -> odd_line(current_letter, target_letter)
    True, False -> even_line(current_letter, target_letter)
    False, True -> {
      let nc = next_char(current_letter)
      build_rec(nc, target_letter, { !is_odd_line })
      <> "\n"
